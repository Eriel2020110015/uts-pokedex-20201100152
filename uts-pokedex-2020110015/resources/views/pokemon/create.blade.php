    ...
    <div class="container">
        ...
        <form action="{{ route('pokemon.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" name="hp" class="form-control" value="{{ old('hp') }}" min="0"
                    max="9999">
                @error('hp')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" name="attack" class="form-control" value="{{ old('attack') }}" min="0"
                    max="9999">
                @error('attack')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" name="defense" class="form-control" value="{{ old('defense') }}" min="0"
                    max="9999">
                @error('defense')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            ...
            <button type="submit" class="btn mt-3 btn-success">Create Pokémon</button>
        </form>
    </div>
@endsection
